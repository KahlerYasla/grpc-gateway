...
type FileServiceClient interface {
	...
	DownloadFile(ctx context.Context, in *DonwloadFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadFileResponse], error)
}
...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *DonwloadFileRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[DownloadFileResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], FileService_DownloadFile_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DonwloadFileRequest, DownloadFileResponse]{ClientStream: stream}
...
type FileServiceServer interface {
	...
	DownloadFile(*DonwloadFileRequest, grpc.ServerStreamingServer[DownloadFileResponse]) error
...
func (UnimplementedFileServiceServer) DownloadFile(*DonwloadFileRequest, grpc.ServerStreamingServer[DownloadFileResponse]) error {
...
func _FileService_DownloadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(DonwloadFileRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FileServiceServer).DownloadFile(m, &grpc.GenericServerStream[DonwloadFileRequest, DownloadFileResponse]{ServerStream: stream})
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/internal/service/file/proto/file.proto",
}
